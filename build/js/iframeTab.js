...
(function () {
    iframeTab = jQuery.prototype = {
        ...
        init: function (option) {
            ...
            $.extend({
                stellung: function (event) { // 任意位置的超鏈接
                    var $this = $(this),
                        link = $this.attr('href'),
                    ...
                    // 插入新標籤
                    var stellen = function stellen(cb) {
                ...
                creatContextmenu: function (e) { // 右鍵菜單
                    var $this = $(this),
                        x = e.clientX,
                        y = e.clientY,
            ...
            $(document).on('mouseup', 'a[data-num]', $.stellung);
            ...
            $('.tabs-header').on('mousedown', $.creatContextmenu);
            ...
            tab = {
                ...
                destroy: function () {
                    $(document).off('mouseup', 'a[data-num]').off('click.tab.change', '.tabs-header li:not(.active)')
                               .off('click.tab.close', '.tabs-header li [data-btn="close"]').off('click', '[data-btn="refresh"]');
                    $('.tabs-header').off('mousedown');
                    delete tab.on;
                    delete tab.closeActIframe;
                    delete tab.destroy;
                    delete tab.constructor;
                },
